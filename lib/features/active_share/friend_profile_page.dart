  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        iconTheme: const IconThemeData(color: AppColors.kPrimaryColor, weight: 600),
        ...
        centerTitle: true,
        title: Text(name, style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 25, color: AppColors.kPrimaryColor)),
      ),
